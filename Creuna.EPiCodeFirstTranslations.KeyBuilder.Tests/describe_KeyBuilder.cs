...
namespace Creuna.EPiCodeFirstTranslations.KeyBuilder.Tests
{
    class describe_KeyBuilder : KeyBuilder_spec
    {
        ...
        void when_asking_keys_for_the_root_translations_class()
        {
            ...
            it["it allows to have several properties of the same type"] = () => translationsKeyBuilder.GetTranslationKey(x => x.AlternateLabels.Label1).Should().Be("/AlternateLabels/Label1");
        }
